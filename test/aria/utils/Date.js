...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        testUTCFormat : function () {
            var dt = new Date(Date.UTC(2014, 2, 30, 2, 15, 0, 0)); // 30/02/2014 02:15:00 UTC
            this.assertEquals(aria.utils.Date.format(dt, 'HH:mm', true), "02:15", "30/02/2014 02:15:00 UTC should be formated to '02:15' but got %1");
        }
    }
});
